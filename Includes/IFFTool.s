...
;	IN	:	d0.w = largeur en octets d'un plan
...
; IN	:	d0.w = nombre de couleurs (max 32)
...
;	IN	:	a0.l = adresse du son
;				a1.l = adresse du buffer pour le sample
; OUT	:	d0.l = 0 si erreur, taille sample sinon
